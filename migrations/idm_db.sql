...
ALTER TABLE ONLY public.login_2fa
    ADD CONSTRAINT login_2fa_pkey PRIMARY KEY (uuid);
...
--
-- Name: login_2fa login_2fa_login_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: idm
--

ALTER TABLE ONLY public.login_2fa
    ADD CONSTRAINT login_2fa_login_uuid_fkey FOREIGN KEY (login_uuid) REFERENCES public.login(uuid);
