...
-- Add login_id column
ALTER TABLE password_reset_tokens ADD COLUMN login_id UUID;
...
ALTER TABLE password_reset_tokens ALTER COLUMN login_id SET NOT NULL;
...
ALTER TABLE password_reset_tokens DROP CONSTRAINT IF EXISTS password_reset_tokens_login_id_fkey CASCADE;

-- Drop login_id column
ALTER TABLE password_reset_tokens DROP COLUMN login_id;
