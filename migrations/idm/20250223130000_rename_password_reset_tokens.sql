...
ALTER TABLE public.password_reset_tokens DROP CONSTRAINT IF EXISTS password_reset_tokens_login_id_fkey;

-- Rename the table
ALTER TABLE public.password_reset_tokens RENAME TO login_password_reset_tokens;

-- Add foreign key constraint back with new name
ALTER TABLE public.login_password_reset_tokens ADD CONSTRAINT login_password_reset_tokens_login_id_fkey 
...
-- Drop foreign key constraint
ALTER TABLE public.login_password_reset_tokens DROP CONSTRAINT IF EXISTS login_password_reset_tokens_login_id_fkey;

-- Rename the table back
ALTER TABLE public.login_password_reset_tokens RENAME TO password_reset_tokens;
