  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2
            class="text-2xl font-bold leading-7 text-gray-12 sm:truncate sm:text-3xl sm:tracking-tight"
          >
      ...
      >
        ...
        >
          <div
            class="overflow-hidden bg-white shadow rounded-lg"
          >
            <form
          ...
          <div
            class="mt-8 overflow-hidden bg-white shadow rounded-lg"
          >
            <div
              class="px-4 py-5 sm:p-6"
            >
              <h3
                class="text-lg font-medium leading-6 text-gray-12"
              >
                Reset Password
              </h3>
              <div
                class="mt-2 max-w-xl text-sm text-gray-9"
              >
          ...
          >
            ...
            >
              ...
              <Show
                when={showTwoFactorSection()}
              >
                <div
                  class="mt-5 space-y-4"
                >
                  <Show
                    when={!twoFactorEnabled() && twoFactorQrCode()}
                  >
                    <div>
                      <h4
                        class="text-md font-medium text-gray-11"
                      >
                      ...
                      >
                        <p
                          class="text-sm text-gray-9"
                        >
                          Or enter this code manually:
                          {' '}
                          <code
                            class="bg-gray-3 px-2 py-1 rounded"
                          >
                            {twoFactorSecret()}
                          </code>
                        </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        class="text-sm text-gray-9 mt-1"
                      >
                        Save these backup codes in a secure location. Each code can only be used once.
                      </p>
                      <div
                        class="mt-2 bg-gray-3 p-4 rounded-lg"
                      >
                        <ul
