...
function Pagination<T extends ValidComponent = 'nav'>(props: PolymorphicProps<T, PaginationRootProps<T>>) {
...
function PaginationItem<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, PaginationItemProps<T>>) {
...
function PaginationEllipsis<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, PaginationEllipsisProps<T>>) {
...
function PaginationPrevious<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, PaginationPreviousProps<T>>) {
...
function PaginationNext<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, PaginationNextProps<T>>) {
