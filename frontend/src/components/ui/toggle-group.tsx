...
function ToggleGroup<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ToggleGroupRootProps<T>>) {
...
function ToggleGroupItem<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, ToggleGroupItemProps<T>>) {
