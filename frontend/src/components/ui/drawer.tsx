...
function DrawerOverlay<T extends ValidComponent = 'div'>(props: DynamicProps<T, DrawerOverlayProps<T>>) {
...
function DrawerContent<T extends ValidComponent = 'div'>(props: DynamicProps<T, DrawerContentProps<T>>) {
...
function DrawerTitle<T extends ValidComponent = 'div'>(props: DynamicProps<T, DrawerTitleProps<T>>) {
...
function DrawerDescription<T extends ValidComponent = 'div'>(props: DynamicProps<T, DrawerDescriptionProps<T>>) {
