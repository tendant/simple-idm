...
function AlertDialogOverlay<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, AlertDialogOverlayProps<T>>) {
...
function AlertDialogContent<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, AlertDialogContentProps<T>>) {
...
function AlertDialogTitle<T extends ValidComponent = 'h2'>(props: PolymorphicProps<T, AlertDialogTitleProps<T>>) {
...
function AlertDialogDescription<T extends ValidComponent = 'p'>(props: PolymorphicProps<T, AlertDialogDescriptionProps<T>>) {
