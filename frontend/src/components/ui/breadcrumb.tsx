...
function BreadcrumbLink<T extends ValidComponent = 'a'>(props: PolymorphicProps<T, BreadcrumbLinkProps<T>>) {
...
function BreadcrumbSeparator<T extends ValidComponent = 'span'>(props: PolymorphicProps<T, BreadcrumbSeparatorProps<T>>) {
