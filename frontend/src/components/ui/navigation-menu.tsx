...
function NavigationMenu<T extends ValidComponent = 'ul'>(props: PolymorphicProps<T, NavigationMenuProps<T>>) {
...
function NavigationMenuTrigger<T extends ValidComponent = 'button'>(props: PolymorphicProps<T, NavigationMenuTriggerProps<T>>) {
...
function NavigationMenuViewport<T extends ValidComponent = 'li'>(props: PolymorphicProps<T, NavigationMenuViewportProps<T>>) {
...
function NavigationMenuContent<T extends ValidComponent = 'ul'>(props: PolymorphicProps<T, NavigationMenuContentProps<T>>) {
...
function NavigationMenuLink<T extends ValidComponent = 'a'>(props: PolymorphicProps<T, NavigationMenuLinkProps<T>>) {
...
function NavigationMenuLabel<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, NavigationMenuLabelProps<T>>) {
...
function NavigationMenuDescription<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, NavigationMenuDescriptionProps<T>>) {
